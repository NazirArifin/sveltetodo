  ...
  <div class="max-w-[85rem] px-4 pt-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
      ...
      <form class="my-4">
        <div class="grid grid-cols-6 px-6 py-2">
          ...
          <div class="col-span-5">
            <input type="text" id="judul" name="judul" class="py-4 px-3 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Judul Kiriman">
          </div>
        </div>
        ...
        <div class="grid grid-cols-6 px-6 py-2">
          ...
          <div class="col-span-2">
            <select id="kategori" name="kategori" class="py-4 px-3 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500">
        ...
        <div class="grid grid-cols-6 px-6 py-2">
          ...
          <div class="col-span-5">
            <textarea id="deskripsi" name="deskripsi" class="py-4 px-3 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" rows="15" placeholder="Deskripsi Kiriman"></textarea>
          </div>
        </div>
      ...
      <div class="px-6 py-4 grid gap-3 md:flex md:justify-end md:items-center border-t border-gray-200">
        <div>
          <div class="inline-flex gap-x-2">
            <button type="button" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-gray-500 text-gray-500 hover:border-gray-800 hover:text-gray-800 disabled:opacity-50 disabled:pointer-events-none">
              Batalkan
            </button>
